...
def parse_args():
    ...
    parser.add_argument('--eval_de', action='store_true', help='evaluating ade and fde')
...
#    parser.add_argument('-drop', '--dropout', default=0., type=float, metavar='N', help='dropout probability')
    parser.add_argument('-lr', '--learning-rate', default=0.0001, type=float, metavar='N', help='initial learning rate')
    
    parser.add_argument('-wd', '--weight-decay', default=0.1, type=float, metavar='N', help='learning rate decay per epoch')
    parser.add_argument('-lrd', '--lr-decay', default=0.99, type=float, metavar='N', help='learning rate decay per epoch')
    parser.add_argument('-heads', '--num_heads', default=8, type=float, metavar='N', help='number of heads in transformer')
    parser.add_argument('-depth', '--depth', default=4, type=float, metavar='N', help='depth of the transformer')
    parser.add_argument('-emb', '--embed_dim_ratio', default=32, type=float, metavar='N', help='embeded dimension ratio')
    parser.add_argument('-dd', '--devide_data', default=4, type=float, metavar='N', help='dividing data per epoch')
    parser.add_argument('-drate', '--drop_rate', default=0.4, type=float, metavar='N', help='drop rate')
    parser.add_argument('-adrate', '--attn_drop_rate', default=0.4, type=float, metavar='N', help='attention drop rate')
    parser.add_argument('-dprate', '--drop_path_rate', default=0.2, type=float, metavar='N', help='drop path rate')
    parser.add_argument('-mlp', '--mlp_ratio', default=2, type=float, metavar='N', help='mlp ratio')
